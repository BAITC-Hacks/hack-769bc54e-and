...
Режим: настоящая модель `gpt-5.4-mini` · токенов: 60737 · самый долгий ответ: 5.6 с
...
|---|---|---|---|---|
| dense-wedding | ✅ | 5.6 с | 2 | — |
| all-busy-and-pricey | ✅ | 3.2 с | 2 | — |
| no-category-in-city | ✅ | 2.9 с | 2 | — |
| over-budget | ✅ | 2.5 с | 2 | — |
| same-request-two-dates | ✅ | 3.4 с | 2 | — |
| venue-hall | ✅ | 3.9 с | 2 | — |
| rare-category-with-results | ✅ | 3.2 с | 2 | — |
| language-narrows-the-result | ✅ | 3.2 с | 2 | — |
| duration-narrows-the-result | ✅ | 3.5 с | 2 | — |
