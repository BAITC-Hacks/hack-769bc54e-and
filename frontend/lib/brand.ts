...
export const brand = {
  name: "ТойМатч",
  title: "ТойМатч: подбор подрядчиков для мероприятий",
  description:
    "Три подрядчика, которые свободны в вашу дату и проходят по бюджету. У каждого своя причина, почему именно он.",
  lede: "Три подрядчика, которые свободны в вашу дату и проходят по бюджету. У каждого своя причина, почему именно он.",
  cityLabel: "Город",
...
export const HONESTY_TEXT = {
  ...
  sourceHint: "В исходном датасете организатора профиль не помечен как синтетический.",
  syntheticHint: "Синтетический профиль из исходного датасета организатора. Команда его не добавляла.",
  imputedPriceHint: "Цена проставлена при подготовке датасета и не подтверждена подрядчиком.",
  imputedCityHint: "Город проставлен при подготовке датасета и не подтверждён подрядчиком.",
} as const;
